...
(function(q) {
    ...
    for (var t = CryptoJS, n = t.lib, v = n.WordArray, u = n.Hasher, n = t.algo, a = [], s = 0; 64 > s; s++)
    ...
    n = n.MD5 = u.extend({
        ...
        _doProcessBlock: function(h, m) {
            for (var b = 0; 16 > b; b++) {
                var j = m + b
                  , n = h[j];
                h[j] = (n << 8 | n >>> 24) & 16711935 | (n << 24 | n >>> 8) & 4278255360
            }
        ...
        _doFinalize: function() {
            ...
            g[(j + 64 >>> 9 << 4) + 15] = (k << 8 | k >>> 24) & 16711935 | (k << 24 | k >>> 8) & 4278255360;
            g[(j + 64 >>> 9 << 4) + 14] = (b << 8 | b >>> 24) & 16711935 | (b << 24 | b >>> 8) & 4278255360;
            ...
            for (b = 0; 4 > b; b++)
                j = g[b],
                g[b] = (j << 8 | j >>> 24) & 16711935 | (j << 24 | j >>> 8) & 4278255360;
            return a
        },
        clone: function() {
...
(function() {
    ...
    q.algo.HMAC = q.lib.Base.extend({
        init: function(k, g) {
            ...
            g.clamp();
            for (var n = this._oKey = g.clone(), v = this._iKey = g.clone(), u = n.words, a = v.words, s = 0; s < p; s++)
                u[s] ^= 1549556828,
                a[s] ^= 909522486;
