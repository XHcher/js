...
function aes(text) {
    ...
    var data = {'Login':{}}
    var encrypt_iv, encrypt_key
    var o = CryptoJS.MD5(Math.random() + "").toString();  //ÃØÔ¿
    t = CryptoJS.AES.encrypt(text, o, {
    ...
    data.Login.encrypt_key = encrypt_key
    data.Login.encrypt_iv = encrypt_iv
    data.Login.password_encode = password_encode
    data.dsc_token = dsc_token
    return data
}